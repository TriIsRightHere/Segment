...
def upload_file():
    ...
    subprocess.run(['python', '../scripts/amg.py', '--checkpoint', '../sam_vit_h_4b8939.pth', '--model-type', 'vit_h' , '--input', file_path, '--output', '../sam-fe/app/src/assets/data/masks'], capture_output=True)
